...
L1 = 223.6; %Dimensiones del largo de la figura que recorrerá el EF
%Grupo #10
...
T0=R.fkine([0 0 0 0 0 0]) %Inv Kinemathics para Posición incial del robot

%Puntos que recorrerá el robot en el espacio de trabajo
...
%Trayectorias resultantes de las rutas establecidas
T_traj = ctraj(T0,p1,20);
T_traj2 = ctraj(p1,p2,20);
T_traj3 = ctraj(p2,p3,20);
T_traj4 = ctraj(p3,p4,20);

%Vector para guardar la trayectoria y posterior graficación
